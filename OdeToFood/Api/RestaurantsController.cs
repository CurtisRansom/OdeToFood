...
namespace OdeToFood.Api
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        // GET: api/Restaurants
        [HttpGet]
        public IEnumerable<Restaurant> GetRestauruants()
        {
            return _context.Restauruants;
        }
        ...
        public async Task<IActionResult> GetRestaurant([FromRoute] int id)
        {
            ...
            var restaurant = await _context.Restauruants.FindAsync(id);
        ...
        public async Task<IActionResult> PostRestaurant([FromBody] Restaurant restaurant)
        {
            ...
            _context.Restauruants.Add(restaurant);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteRestaurant([FromRoute] int id)
        {
            ...
            _context.Restauruants.Remove(restaurant);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.Restauruants.Any(e => e.Id == id);
        }
    }
}